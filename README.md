...
A PS/2 connector and cable is what's used between the base and keypad. Importantly, neither device actually speaks the PS/2 protocol! PS/2 was just chosen because connectors and cables are readily available. You should not connect either device to anything else.
